    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ИП Иванов</div>
                <div class="email">ipivanov@example.com</div>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2016 - 2017 <a href="javascript:void(0);">Admin Panel</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0.5
            </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="settings">
                <div class="demo-settings">
                    ...
                    <ul class="setting-list">
                        ...
                        <li>
                            <span>Location Permission111111111</span>
                            <div class="switch">
                                <label><input type="checkbox" checked><span class="lever"></span></label>
                            </div>
                        </li>
